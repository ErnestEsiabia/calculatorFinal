...
//#import "Film.h"
//
//@implementation DataSouuce
//@synthesize delegate;
//
//-(NSMutableArray *)
//selectFromJson:(NSString *)title{NSMutableArray *masterList = [[NSMutableArray alloc]init];
//    
//    NSString *s_jason = [self getJsonDataString:title getJsonDataString:title];
...
//    NSString *url = [DataSouuce baseAPIUrl];
//    
//    
//    //    s=star%20wars
//    
...
//    NSURL *jsonUrl = [NSURL URLWithString:[DataSouuce encodeURIComponent:url]];
//    
